...
class Api(QMainWindow):
    def __init__(self):
        ...
        self.deletebtn.clicked.connect(self.delete_pt)
        self.setFocusPolicy(QtCore.Qt.StrongFocus)
        self.searchbtn.clicked.connect(self.address_finder)
        self.indexbtn.setFocusPolicy(QtCore.Qt.NoFocus)
        self.indexbtn.clicked.connect(self.show_index)
    ...
    def address_finder(self):
        ...
        if not response:
            ...
            self.full_adress.setText(self.toponym_address)
    ...
    def show_index(self):
        self.full_adress.setText(self.toponym_address + self.postcode)
